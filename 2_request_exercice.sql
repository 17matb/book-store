...
SELECT SUM(stock) AS 'Somme totale des stocks de livres' 
FROM book;
...
WHERE c.customer_id = 1; /* si l'on veut afficher les commandes d'un client donné, on cherche son customer_id */
